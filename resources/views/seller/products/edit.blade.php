    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-sm-0">Ubah Data Barang</h3>
    ...
    <div class="row">
        <form action="{{ route('product.update', $product->slug) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <label for="title" class="form-label h5">Nama Barang</label>
                                <ul>
                                    <li>
                                        <small class="text-muted">Pastikan nama barang memuat merek, tipe dan spesifikasi
                                            penting.
                                        </small>
                                    </li>
                                    <li>
                                        <small class="text-muted">Nama masih dapat diubah jika barang belum masuk ke
                                            transaksi.</small>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" name="title"
                                    ...
                                    placeholder="Nama Produk" value="{{ $product->title }}">
                                @error('title')
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <label for="product_sub_category" class="form-label h5">Kategori Barang</label>
                                {{-- <ul>
                            ...
                            <div class="col-lg-8">
                                <select name="product_sub_category_id"
                                    ...
                                    @foreach ($category as $ct)
                                        @if ($product->product_sub_category_id === $ct->id)
                                            <option value="{{ $ct->id }}" selected>
                                                {{ $ct->product_category->name . ' / ' . $ct->name }}
                                            </option>
                                        @else
                                            <option value="{{ $ct->id }}">
                                                {{ $ct->product_category->name . ' / ' . $ct->name }}
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input type="number" name="price"
                                    ...
                                    placeholder="Harga Satuan" value="{{ $product->price }}">
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <label for="stock" class="form-label h5">Stok Barang</label>
                            ...
                            <div class="col-lg-8">
                                <input type="number" name="stock"
                                    ...
                                    placeholder="Jumlah Stok" value="{{ $product->stock }}">
                                @error('stock')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                ...
                                <small class="text-muted d-block">Cocok untuk kamu yang ingin jual barang eceran.</small>
                            </div>
                            <div class="col-lg-8">
                                <input type="number" name="minimum_order"
                                    class="form-control form-control-lg @error('minimum_order') is-invalid @enderror"
                                    id="minimum_order" placeholder="Pembelian Minimum"
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <label for="condition" class="form-label h5">Kondisi Barang</label>
                                <small class="text-muted d-block">Isi sesuai dengan yang asli.</small>
                            </div>
                            <div class="col-lg-8">
                                <div class="form-check form-radio-secondary form-check-inline">
                                    <input class="form-check-input" type="radio" name="condition" value="baru"
                                        id="baru" @if ($product->condition == 'baru') checked @endif>
                                ...
                                <div class="form-check form-radio-primary form-check-inline">
                                    <input class="form-check-input" type="radio" name="condition" value="bekas"
                                        id="bekas" @if ($product->condition == 'bekas') checked @endif>
                                ...
                                <div class="image-upload">
                                    <label for="file-input1">
                                        <img id="img-preview-1" class="img-fluid"
                                            src="@if ($product->image1 != '') {{ asset('storage/product_images/' . $product->image1) }} @else https://i.ibb.co/rkZhjpQ/img-upload.png @endif"
                                            alt="img-upload" border="0">
                                    </label>

                                    <input type="hidden" name="image1_last"
                                        value="@if ($product->image1 != '') {{ $product->image1 }} @endif">
                                ...
                                <div class="image-upload">
                                    <label for="file-input2">
                                        <img id="img-preview-2" class="img-fluid"
                                            src="@if ($product->image2 != '') {{ asset('storage/product_images/' . $product->image2) }} @else https://i.ibb.co/rkZhjpQ/img-upload.png @endif"
                                            alt="img-upload" border="0">
                                    </label>

                                    <input type="hidden" name="image2_last"
                                        value="@if ($product->image2 != '') {{ $product->image2 }} @endif">
                                ...
                                <div class="image-upload">
                                    <label for="file-input3">
                                        <img id="img-preview-3" class="img-fluid"
                                            src="@if ($product->image3 != '') {{ asset('storage/product_images/' . $product->image3) }} @else https://i.ibb.co/rkZhjpQ/img-upload.png @endif"
                                            alt="img-upload" border="0">
                                    </label>

                                    <input type="hidden" name="image3_last"
                                        value="@if ($product->image3 != '') {{ $product->image3 }} @endif">
                                ...
                                <div class="image-upload">
                                    <label for="file-input4">
                                        <img id="img-preview-4" class="img-fluid"
                                            src="@if ($product->image4 != '') {{ asset('storage/product_images/' . $product->image4) }} @else https://i.ibb.co/rkZhjpQ/img-upload.png @endif"
                                            alt="img-upload" border="0">
                                    </label>

                                    <input type="hidden" name="image4_last"
                                        value="@if ($product->image4 != '') {{ $product->image4 }} @endif">
                                ...
                                <div class="image-upload">
                                    <label for="file-input5">
                                        <img id="img-preview-5" class="img-fluid"
                                            src="@if ($product->image5 != '') {{ asset('storage/product_images/' . $product->image5) }} @else https://i.ibb.co/rkZhjpQ/img-upload.png @endif"
                                            alt="img-upload" border="0">
                                    </label>

                                    <input type="hidden" name="image5_last"
                                        value="@if ($product->image5 != '') {{ $product->image5 }} @endif">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header p-4">
                        <h4 class=" mb-0">Pengiriman Barang</h4>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                ...
                                <small class="text-muted d-block">Jika barang atau kemasan berukuran besar, sebaiknya isi
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="number" name="weight"
                                        ...
                                        aria-describedby="weight-addon" value="{{ $product->weight }}">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="number" name="process_time"
                                        ...
                                        aria-describedby="process_time-addon" value="{{ $product->process_time }}">
            ...
            <div class="col-lg-12">
                <button type="button" class="btn btn-warning">Simpan ke draf</button>
