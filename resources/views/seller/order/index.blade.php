            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills arrow-navtabs nav-info bg-light mb-4" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#menunggu-pembayaran" id="tab-pending"
                                role="tab" aria-selected="true">Menunggu Pembayaran</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#terbayar" id="tab-settlement" role="tab"
                                aria-selected="false">Terbayar</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#diproses" id="tab-process" role="tab"
                                aria-selected="false">Diproses</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#dikirim" id="tab-sending" role="tab"
                                aria-selected="false">Dikirim</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#selesai" id="tab-finish" role="tab"
                                aria-selected="false">Selesai</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#batal" id="tab-cancel" role="tab"
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#order-pending').DataTable({
                ...
                ajax: "{{ route('seller.order.pending') }}",
                columns: [{
                        data: 'link',
                        name: 'order_number'
                    },
            ...
            var table = $('#order-terbayar').DataTable({
                ...
                ajax: "{{ route('seller.order.terbayar') }}",
                columns: [{
                        data: 'link',
                        name: 'order_number'
                    },
            ...
            var table = $('#order-diproses').DataTable({
                ...
                ajax: "{{ route('seller.order.diproses') }}",
                columns: [{
                        data: 'link',
                        name: 'order_number'
                    },
            ...
            var table = $('#order-dikirim').DataTable({
                ...
                ajax: "{{ route('seller.order.dikirim') }}",
                columns: [{
                        data: 'link',
                        name: 'order_number'
                    },
            ...
            var table = $('#order-selesai').DataTable({
                ...
                ajax: "{{ route('seller.order.selesai') }}",
                columns: [{
                        data: 'link',
                        name: 'order_number'
                    },
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            $.each(response.data, function(i, v) {
                                ...
                                if (v != 0) {
                                    $('#tab-' + i).append(
                                        '<span class="badge bg-primary badge-pill ms-3 align-top">' +
                                        v + '</span>'
                                    );
                                }
                            });
