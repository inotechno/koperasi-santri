        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            <div class="card mt-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="p-2 mt-4">
                        <form action="{{ route('register.store.seller') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="store_name"
                                    ...
                                    placeholder="Enter Nama Toko" value="{{ old('store_name') }}">
                                @error('store_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
            ...
            <div class="mt-4 text-center">
                <a href="{{ route('register') }}" class="btn col-12 btn-warning mb-2">Daftar Jadi Pembeli</a>
