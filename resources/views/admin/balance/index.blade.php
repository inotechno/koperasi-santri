...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Saldo</a></li>
        ...
        <div class="col-lg-3">
            <div class="card">
                ...
                <div class="card-body p-0 border-0 bg-soft-light">
                    ...
                    @if ($seller->rekening !== null)
                        <div class="my-3 text-center">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" id="btn-withdraw"
                                data-bs-target="#withdrawModal">Cairkan Saldo</button>
                        </div>
                    @endif
                </div>
    ...
    <form method="POST" id="form-withdraw" action="{{ route('seller.withdraw') }}">
