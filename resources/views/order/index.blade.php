            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills arrow-navtabs nav-info bg-light mb-4" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#terbayar" id="tab-settlement"
                                role="tab" aria-selected="false">Terbayar</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content text-muted">
                        ...
                        <div class="tab-pane active" id="terbayar" role="tabpanel">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function getCount() {
                $.ajax({
                    type: "get",
                    url: "{{ route('order.count.transaction') }}",
                    dataType: "JSON",
