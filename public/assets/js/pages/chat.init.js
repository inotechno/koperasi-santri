var dummyUserImage = base_url + "/images/users/user-dummy-img.jpg",
  dummyMultiUserImage = base_url + "/images/users/multi-user.jpg",
  isreplyMessage = !1;
...
var getChatList = function (e, t) {
  ...
  emojiPicker = new FgEmojiPicker({
    ...
    position: ["top", "right"],
    preFetch: !0,
    dir: base_url + "assets/js/pages/plugins/json",
