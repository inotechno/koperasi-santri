var basicRating, starRatingStep;
...
var starRatingmessage, starRatingunlimited, starRatinghover, starRatingreset, messageDataService = {
    rate: function (e) {
        return {
            then: function (e) {
                setTimeout(function () {
...
document.querySelector(".rater-product") && (starRatingmessage = raterJs({
    isBusyText: "Rating in progress. Please wait...",
    starSize: 15,
    rating: document.querySelector(".rater-product").getAttribute("data"),
    readOnly: !0,
    element: document.querySelector(".rater-product"),
    rateCallback: function (e, t) {
