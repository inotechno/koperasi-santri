! function () {
    ...
    function y(e) {
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = base_url + "images/flags/us.svg" : "sp" == e ? document.getElementById("header-lang-img").src = base_url + "images/flags/spain.svg" : "gr" == e ? document.getElementById("header-lang-img").src = base_url + "images/flags/germany.svg" : "it" == e ? document.getElementById("header-lang-img").src = base_url + "images/flags/italy.svg" : "ru" == e ? document.getElementById("header-lang-img").src = base_url + "images/flags/russia.svg" : "ch" == e ? document.getElementById("header-lang-img").src = base_url + "images/flags/china.svg" : "fr" == e && (document.getElementById("header-lang-img").src = base_url + "images/flags/french.svg"), localStorage.setItem("language", e), b = localStorage.getItem("language"), function () {
            null == b && y(g);
            var e = new XMLHttpRequest;
            e.open("GET", base_url + "lang/" + b + ".json"), e.onreadystatechange = function () {
                var a;
    ...
    function E() {
        var n, e, t = document.documentElement.getAttribute("data-layout"),
            ...
            a = JSON.parse(a);
        !a || "twocolumn" != t && "twocolumn" != a["data-layout"] || (document.querySelector(".navbar-menu").innerHTML = c, (n = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="' + base_url + '/images/logo-sm.png" alt="" height="22"></a>', Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function (e) {
